...
public class ProductWeb {
    ...
    public ResponseEntity<ProductSupplierDto> findById(@PathVariable("productId") String id) {
        return ResponseEntity.ok().body(productMapper.productToProductSupplierDto(productService.findById(id).get()));
    }
